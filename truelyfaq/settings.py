...
INSTALLED_APPS = [
    ...
    # Local apps
    'truelyfaq.accounts.apps.AccountsConfig',
    'truelyfaq.questions.apps.QuestionsConfig',
    'truelyfaq.faqs.apps.FaqsConfig',
    'truelyfaq.api.apps.ApiConfig',
]
...
WSGI_APPLICATION = 'truelyfaq.wsgi.application'
...
if DEBUG:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'truelyfaq'),
